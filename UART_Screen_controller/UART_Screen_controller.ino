...
int commandFromScreen = 0;

/* Nextion declarations */
NexButton b0 = NexButton(0, 2, "b0");
NexButton b2 = NexButton(0, 3, "b2");
NexNumber x0 = NexNumber(0, 8, "x0");
NexProgressBar progress2 = NexProgressBar(0, 7, "progress2");
NexWaveform wave = NexWaveform(1, 1, "wave");
...
void loop(void) {
  ...
  //progress2.setValue((int)map((int)inpVoltage.float_value, 40, 50, 0, 100));
  //x0.setValue((int)(inpVoltage.float_value * 100));
  //x0.setValue((int)(3333));
  //wave.addValue(0, (int)map((int)brake_current.float_value,   0, 42,    0, 255));
  //wave.addValue(1, (int)map((int)avgInputCurrent.float_value, 0, 45,    1, 255));
  //wave.addValue(2, (int)map((int)rpm.float_value,             0, 15000, 2, 255));
